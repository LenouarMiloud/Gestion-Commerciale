 ...
 * @author Anonyme
 */
public class FacturesFournisseur extends javax.swing.JFrame {

    String[] ref, tva, lib;
    String ref1, tva1, lib1;
    
    public FacturesFournisseur() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Factures Fournisseur");
        setResizable(false);

        NumFournisseur1.setFont(new java.awt.Font("Dialog", 1, 15)); // NOI18N
        NumFournisseur1.setText("Fournisseur :");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGap(271, 271, 271)
                        .addComponent(Premier, javax.swing.GroupLayout.PREFERRED_SIZE, 65, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	...
	DateFacture.setText(dateFormat.format(date));
        ...
        if( Fournisseur.getSelectedIndex()!=-1 && ModeReglement.getSelectedIndex()!=-1 && model.getRowCount()!=0 ) {
    ...
    private void SuivantActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SuivantActionPerformed
        ...
        if(!DB.factures.isEmpty() && Move<DB.factures.size()-1) {
            ...
            Fournisseur.setSelectedItem(DB.factures.get(Move).getNumClient());
